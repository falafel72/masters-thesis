...
a corrective optic, which allows us to use a simple camera model described in
Section\nbsp[[sec:pinhole]]. Developed by Backscatter, this corrective optic is designed
...
In order to justify that we keep the corrective optic on during operation, we
conducted simulations k
