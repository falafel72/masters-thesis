#+OPTIONS: toc:nil H:5
#+SETUPFILE: setup.org
#+TITLE: Laser-Powered Citizen Science: Enhancing Fish Length Measurement in Marine Environments with Underwater Imaging
...
*** Outline :noexport:
- what part of the overall system are we discussing in the document?
- what are the accuracy bounds of our desired data?
-
- what particular technologies are we comparing against?
...
Recall the function $\mathbf{g}(\alpha,\ell)$:
\begin{equation*}
    \mathbf{g}(\alpha,\ell) = \begin{bmatrix}
...
Zhang's procedure\nbsp\ref{Zhang2000}, where many images of a checkerboard are
...
the diver be able to orient and maneuver them selves
...
order to perform this processing, though the details are out of scope of this
document.
** Conclusion :ignore:
