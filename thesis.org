#+OPTIONS: toc:nil H:5
#+SETUPFILE: setup.org
#+TITLE: Fishsense Lite: Measuring Fish Length Data with an Underwater Laser Rangefinder
...
the restriction that the laser dot must be trained on the fish. A full field
...
#+ATTR_LATEX: :scale 0.05
#+ATTR_ORG: :width 200px
#+CAPTION: Measurements of Fred, plotted over estimated distances away from the camera.
#+LABEL: fig:fred
[[file:images/fred-measurements.jpg]]
...
These have typically failed after
